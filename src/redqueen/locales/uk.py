...
# --- Модерація --------------------------------------------------------------
BANNED = "\U0001F534 <b>{name}</b> ліквідовано (бан){until}."
...
# --- Нові функції ---
GLOBAL_BANNED = "🛑 <b>{name}</b> був автоматично видалений, оскільки знаходиться у вашому глобальному чорному списку."
GLOBAL_BANNED_REASON = "🛑 <b>{name}</b> був автоматично видалений, оскільки знаходиться у вашому глобальному чорному списку (Причина: {reason})."
WELCOME_DEFAULT = "Ласкаво просимо, <b>{name}</b>!"
