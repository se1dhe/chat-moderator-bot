...
# --- Новые функции ---
GLOBAL_BANNED = "🛑 <b>{name}</b> был автоматически удален, так как находится в вашем глобальном черном списке."
GLOBAL_BANNED_REASON = "🛑 <b>{name}</b> был автоматически удален, так как находится в вашем глобальном черном списке (Причина: {reason})."
WELCOME_DEFAULT = "Добро пожаловать, <b>{name}</b>!"
