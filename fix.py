...
uk = """    'sec.triggers': 'Авто-Відповіді',
...
text = re.sub(r"    'sec.triggers': 'Auto-Replies',\n    'sec.triggers.desc': 'Custom command triggers',", en, text)
text = re.sub(r"    'sec.triggers': 'Авто-Ответы',\n    'sec.triggers.desc': 'Кастомные триггеры и команды',", ru, text)
text = re.sub(r"    'sec.triggers': 'Авто-Відповіді',\n    'sec.triggers.desc': 'Кастомні тригери та команди',", uk, text)
