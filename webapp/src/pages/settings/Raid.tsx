...
export default function Raid({ s, t }) {
  ...
  return (
    <>
      ...
      {r.locked && (
        <div className="bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-neutral-800/60 rounded-2xl p-4 mb-4 shadow-sm w-full flex items-center gap-3">
