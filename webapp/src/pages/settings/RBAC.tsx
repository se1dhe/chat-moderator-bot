    ...
    <div className="space-y-6">
      <div className="card p-4 space-y-4">
        <div className="flex gap-2">
          ...
          />
          <button 
            className="w-full flex items-center justify-center gap-2 py-3 bg-primary hover:bg-primary-dark text-white rounded-xl font-bold transition-all active:scale-95 shadow-md shadow-primary/20 text-[15px]"
            onClick={handleAdd}
