  ...
  return (
    <>
      ...
      <div className="bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-neutral-800/60 rounded-2xl p-2 mb-4 shadow-sm w-full">
        ...
        {d.enabled && (
          <>
            <Row title={t('defcon.threshold')} value={`${d.threshold} / min`}>
      ...
      {d.enabled && (
        <>
          <div className="text-sm font-semibold text-neutral-500 uppercase tracking-wider ml-1 mt-4 mb-2">{t('defcon.action')}</div>
