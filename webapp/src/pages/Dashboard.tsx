            ...
            {g.items.map((it) => {
              ...
              return (
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  key={it.key}
                  className="w-full flex items-center p-4 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl shadow-sm hover:border-primary/30 dark:hover:border-primary/30 active:bg-neutral-50 dark:active:bg-neutral-800 transition-all text-left group"
                  onClick={() => {
                    haptic('light');
