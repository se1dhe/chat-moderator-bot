...
export function Landing() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-black text-neutral-900 dark:text-neutral-50 font-sans selection:bg-primary/20">
      ...
      {/* Header */}
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/80 dark:bg-black/70 backdrop-blur-xl shadow-sm border-b border-neutral-200 dark:border-neutral-800/60 py-3' : 'bg-transparent py-5'}`}>
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl overflow-hidden shadow-sm border border-neutral-200 dark:border-neutral-800/60">
      ...
      <main className="pt-32">
        ...
        <section className="px-6 pb-24 md:pb-32 md:pt-16 max-w-7xl mx-auto text-center flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 mt-24 w-full max-w-4xl animate-in slide-in-from-bottom-8">
            <div className="flex flex-col items-center p-6 rounded-3xl bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-neutral-800/60 shadow-sm">
        ...
        {/* Features */}
        <section id="features" className="px-6 py-24 bg-white dark:bg-[#0a0a0a] border-y border-neutral-200 dark:border-neutral-800/60">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="bg-neutral-50 dark:bg-black p-8 rounded-3xl border border-neutral-200 dark:border-neutral-800/60 hover:border-primary/30 transition-colors">
        ...
        <section id="live" className="px-6 py-24 bg-primary/5 dark:bg-primary/5 border-b border-primary/10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-[#0a0a0a] rounded-3xl overflow-hidden border border-neutral-200 dark:border-neutral-800/60 shadow-2xl shadow-primary/5">
        ...
        <section id="pricing" className="px-6 py-24 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            {/* Free */}
            <div className="bg-white dark:bg-[#0a0a0a] p-8 md:p-12 rounded-[2rem] border border-neutral-200 dark:border-neutral-800/60 shadow-sm flex flex-col">
      ...
      {/* Footer */}
      <footer className="border-t border-neutral-200 dark:border-neutral-800/60 py-12 px-6 bg-white dark:bg-[#0a0a0a]">
