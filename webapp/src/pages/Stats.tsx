  ...
  return (
    <div className="w-full flex flex-col gap-5 animate-in fade-in slide-in-from-bottom-2 duration-300 mt-2">
      ...
      <div className="grid grid-cols-2 gap-3 w-full">
        <div className="bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-neutral-800/60 rounded-2xl p-4 flex flex-col justify-center shadow-sm">
      ...
      <div className="bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-neutral-800/60 rounded-2xl p-4 shadow-sm w-full">
      ...
      {cats.length > 0 && (
        <>
          ...
          <div className="bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-neutral-800/60 rounded-2xl p-4 shadow-sm w-full flex flex-col gap-3">
            {cats.map(([cat, n]) => (
